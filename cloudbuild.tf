...
resource "google_cloud_run_service" "ghost-service" {
...
resource "google_cloud_run_service_iam_member" "allUsers" {
  service  = google_cloud_run_service.ghost-service.name
  location = google_cloud_run_service.ghost-service.location
